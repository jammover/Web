...
<%@ include file="includeEx.jsp" %>는 JSP의 라이프 사이클 중 JSP 페이지 번역 및 컴파일 단계에서 필요한 JSP를 읽어서 메인 JSP의 자바 소스 및 클래스에 포함시키는 방식

<jsp:include page="includeEx.jsp" />는 페이지가 호출될 때마다 ㅈ
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxMjM4NCwtMTA2NzAwNjk1MV19
-->